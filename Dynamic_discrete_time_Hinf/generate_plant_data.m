...
P21   = [G eye(n)];
 ...
 % minimal state space realizations for T1, T2, T3  ************CODE IS NOT
 % COMPLETE!!!!!! P11 IS NOT OK, WE NEED T1,T2,T3, and for this we first
 % need a stable, stabilizing controller....
SYS = ss(P11,'min');      
