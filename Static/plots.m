...
plot(leaders_vec(1,:),J(:,1),'-kv','LineWidth',3,'MarkerSize',15);
plot(leaders_vec(1,:),J(:,2),'--ks','LineWidth',3,'MarkerSize',15);
plot(leaders_vec(1,:),J(:,3),'-bo','LineWidth',4,'MarkerSize',15);
plot(leaders_vec(1,:),J(:,4),'--bd','LineWidth',3,'MarkerSize',15);

plot(leaders_vec(1,:),J(:,5),'-gx','LineWidth',3,'MarkerSize',15);
plot(leaders_vec(1,:),J(:,6),'--g*','LineWidth',3,'MarkerSize',15);

plot(leaders_vec(1,:),J(:,7),'--r','LineWidth',3,'MarkerSize',15);
