...
clc
%%% Finding a Gamma to improve performance.
...
for iter = 2:maxIter
    ...
    % New controller
    [K1,J1_true,X1,Y1,Z1,J1_restriction] = StrucH2LMI_new_Gamma(A,B1,B2,Q,R,T,Rstruct,Gamma);   % Now we use the Gamma we computed above.
